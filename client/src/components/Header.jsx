    ...
    <div className="sticky top-0 z-50 bg-white border-b shadow-sm flex justify-between items-center px-6 py-3">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col items-center">
          <img src="/avatar.png" className="w-14 h-14 rounded-full object-cover" />
          <button className="text-emerald-700 border border-emerald-700 text-xs rounded-lg w-[88px] h-6 mt-1
