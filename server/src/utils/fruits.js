...
export async function sumHarvestByGrade({ ownerId = 1, brokerId = null, start = null, end = null } = {}) {
  ...
  const sum_weight = Object.values(summary).reduce((acc, value) => acc + value, 0);
  return { sum_weight, by_grade: summary };
}
